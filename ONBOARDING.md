...
Today (v1.39.0): **43 skills · 4 subagents · 11 slash commands · 2 hooks ·
43 canonical mini-rules · 21 curated MCP servers · 25 curated hook recipes ·
...
- **Skill** — a `SKILL.md` invoked by name (e.g. `/ai:setup`). Lives in
  `workflow/skills/`.
- **Subagent** — an `AGENT.md` a skill can delegate to. Four exist:
  `explore`, `reviewer`, `qa-runner`, `verifier`.
