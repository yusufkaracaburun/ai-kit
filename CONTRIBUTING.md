...
The full set of branch/commit/PR conventions lives in [`standards/rules/git-hygiene.mini.md`](standards/rules/git-hygiene.mini.md) — that file is the source of truth used by `/ai:to-issues`, and other agent skills.
