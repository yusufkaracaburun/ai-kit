...
- **No re-derivation across sessions.** Once written, this CONTEXT.md is the cached truth — future skills (`/review`, `/improve-codebase-architecture`) read this *before* touching code.
