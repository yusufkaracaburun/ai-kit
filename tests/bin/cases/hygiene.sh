...
OUT_CLEAN="$("$HYG" "$AIKIT" --skip-doctor --skip-dedupe --skip-symmetry --skip-memory --skip-repo-skills --skip-context-lean --skip-secrets-gate --skip-test-ci --skip-upstream-drift 2>&1)"
