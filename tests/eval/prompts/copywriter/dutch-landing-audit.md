...
Punch up the Dutch landing-page copy for our integration platform. Keep it in
Dutch. Do not invent product facts or numbers.

Hero h1: "Integreer zonder grenzen. Eén API voor alle externe systemen die je
klanten gebruiken."
Hero sub: "Bouw productintegraties zonder maanden werk aan OAuth, tokenbeheer en
...
Give me the humanizer audit first, then rewritten hero options, then tell me what
