...
Invoke the `aikit-followup` skill with the user's lead as input.
...
Read [`workflow/skills/aikit-followup/SKILL.md`](../skills/aikit-followup/SKILL.md) for the full process, then run it against the current repo:
