...
---
<!-- ai-kit global rule (ADR-0015): When adding or bumping a dependency, prefer the latest stable release; in production-phase repos pair the bump with a migration plan -->
<!-- Source: standards/rules/feedback/latest-stable-deps.mini.md — re-stamp with bin/sync-plugin-rules.sh -->
...
[`project-lifecycle`](./project-lifecycle.md) for the
matrix.
...
- [`project-lifecycle`](./project-lifecycle.md) — phase
  matrix for dep-bump conservatism.
- `twelve-factor.mini.md` — dependency
  isolation principle.
