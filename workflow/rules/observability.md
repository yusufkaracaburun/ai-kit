...
---
<!-- ai-kit global rule (ADR-0015): Structured logs, metrics, and traces — every request observable end-to-end -->
<!-- Source: standards/rules/observability.mini.md — re-stamp with bin/sync-plugin-rules.sh -->
...
- [`error-handling`](./error-handling.md) — when to log vs throw.
