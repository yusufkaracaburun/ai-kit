---
paths: ["**/Models/**", "**/models/**", "**/domain/**", "**/Domain/**", "**/migrations/**", "**/entities/**", "**/schema*", "**/content.config.*", "**/*.prisma", "CONTEXT.md"]
---
<!-- ai-kit global rule (ADR-0015): Before proposing any architecture or data-model change, read the canonical domain entities the change would touch — don't extrapolate from the surface layer (form, controller, route) -->
<!-- Source: standards/rules/domain-model-first.mini.md — re-stamp with bin/sync-plugin-rules.sh -->
...
- `ddd-distilled.mini.md` — the language
