<!-- ai-kit global rule (ADR-0015): Token-budget discipline — grep before read, delegate wide exploration, lean on CONTEXT.md -->
<!-- Source: standards/rules/context-discipline.mini.md — re-stamp with bin/sync-plugin-rules.sh -->
