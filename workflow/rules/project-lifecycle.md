<!-- ai-kit global rule (ADR-0015): Calibrate agent caution to project lifecycle phase (development vs production) -->
<!-- Source: standards/rules/project-lifecycle.mini.md — re-stamp with bin/sync-plugin-rules.sh -->
