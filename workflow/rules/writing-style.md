<!-- ai-kit global rule (ADR-0015): Strip AI tells from every piece of prose you emit; plain words, no em dashes, no jargon nouns, mechanism over feeling -->
<!-- Source: standards/rules/writing-style.mini.md — re-stamp with bin/sync-plugin-rules.sh -->
...
- [`minimal-comments`](./minimal-comments.md) for
