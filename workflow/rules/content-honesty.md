...
- [`writing-style`](./writing-style.md) — how the prose reads.
- `a11y.mini.md` — placeholder text is never a label.
...
`external/plugins-excluded.json` — this and
`responsive-layout.mini.md` were the parts with no
ai-kit equivalent.
