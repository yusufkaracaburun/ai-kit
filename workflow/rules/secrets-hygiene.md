<!-- ai-kit global rule (ADR-0015): Never commit, log, or hard-code secrets — single source for credentials, rotation playbook -->
<!-- Source: standards/rules/secrets-hygiene.mini.md — re-stamp with bin/sync-plugin-rules.sh -->
...
- `twelve-factor.mini.md` — config-in-env.
- [`git-hygiene`](./git-hygiene.md) — branch + commit conventions.
