<!-- ai-kit global rule (ADR-0015): Default to running independent work concurrently — parallel tool calls, Agent forks, cross-session SendMessage — instead of grinding through it serially in the main thread. -->
<!-- Source: standards/rules/parallelize-independent-work.mini.md — re-stamp with bin/sync-plugin-rules.sh -->
