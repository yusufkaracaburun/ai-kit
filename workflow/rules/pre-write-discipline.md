<!-- ai-kit global rule (ADR-0015): Four gates before the first edit — assumptions, minimum diff, surgical scope, verifiable goal -->
<!-- Source: standards/rules/pre-write-discipline.mini.md — re-stamp with bin/sync-plugin-rules.sh -->
