<!-- ai-kit global rule (ADR-0015): Stay within the scope of the current phase or task; capture out-of-scope finds as deferred follow-ups instead of doing them inline -->
<!-- Source: standards/rules/feedback/phase-scope-discipline.mini.md — re-stamp with bin/sync-plugin-rules.sh -->
...
- `pragmatic.nano.md` — minimum-code principle.
- [`grill-first`](./grill-first.md) — surface scope
