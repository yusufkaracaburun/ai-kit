<!-- ai-kit global rule (ADR-0015): Default to no comments; only add one when the WHY is non-obvious and would surprise a future reader -->
<!-- Source: standards/rules/feedback/minimal-comments.mini.md — re-stamp with bin/sync-plugin-rules.sh -->
