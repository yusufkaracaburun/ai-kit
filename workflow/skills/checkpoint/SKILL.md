...
This path replaces §2-§7. See [`transfer-briefing.md`](transfer-briefing.md)
for the full procedure (locate prior artefacts, pick the temp path, write
the briefing, redact, self-check, print the path).
