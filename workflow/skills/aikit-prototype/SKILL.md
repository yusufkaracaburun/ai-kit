...
```bash
bash "$AI_KIT_ROOT/bin/log-skill.sh" aikit-prototype start  # at the start
bash "$AI_KIT_ROOT/bin/log-skill.sh" aikit-prototype done   # at the end (or `abort` if you bail)
```
