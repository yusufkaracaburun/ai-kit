...
emit_<agent>() {
  ...
  local aikit_version="$5" # kit version; do not stamp it into the file (churns every bump)
  # Returns 0 on success; writes its file(s) idempotently.
  # Must include header: "<!-- Generated by ai-kit from standards/rules/<name>.mini.md -->"
}
```
