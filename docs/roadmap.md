...
- [ ] **`mental-model.md` refresh.** Still says 16 skills with the matching table; should mention 19 and link the new subagents + slash commands. Out of scope for PR 0 (which intentionally stayed additive); landing in PR 4 or a small standalone doc PR.
