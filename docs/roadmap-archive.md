# Roadmap — archive (frozen 2026-06-14)

Snapshot of the full historical roadmap before it was trimmed to forward-only
work. Shipped releases are logged release-by-release in [CHANGELOG.md](../CHANGELOG.md);
this file preserves the original planning narratives (completed epics, design
rationale) for reference. Active forward work lives in [roadmap.md](roadmap.md).
