...
- **Stop and hand off.** If context is approaching the limit *and* work is unfinished, run `/aikit-handoff` to compact into a doc and `/clear` to start fresh. Mid-task token-exhaustion produces worse work than a deliberate restart.
